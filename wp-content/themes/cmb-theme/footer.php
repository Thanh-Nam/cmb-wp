<!-- ======= CONTACT CTA ======= -->
        ...
        <div class="l-footer__inner">
          ...
          <div class="l-footer__brand">
            <nav class="l-footer__social" aria-label="Mạng xã hội CMB">
              <?php if ( $social_fb ) : ?>
              <a href="<?php echo $social_fb; ?>" class="l-footer__social-link" target="_blank" rel="noopener noreferrer" aria-label="Theo dõi CMB trên Facebook" title="CMB Facebook">
              ...
              <?php endif; ?>
              <?php if ( $social_yt ) : ?>
              <a href="<?php echo $social_yt; ?>" class="l-footer__social-link" target="_blank" rel="noopener noreferrer" aria-label="Theo dõi CMB trên YouTube" title="CMB YouTube">
              ...
              <?php endif; ?>
              <?php if ( $social_li ) : ?>
              <a href="<?php echo $social_li; ?>" class="l-footer__social-link" target="_blank" rel="noopener noreferrer" aria-label="Theo dõi CMB trên LinkedIn" title="CMB LinkedIn">
          ...
          <address class="l-footer__branch" id="footer-branch-hn">
            ...
            <ul class="l-footer__branch-list" role="list">
              ...
              <li class="l-footer__branch-item">
                ...
                <a href="mailto:<?php echo $branch_hn_email; ?>" aria-label="Email trụ sở chính CMB"><?php echo $branch_hn_email; ?></a>
              </li>
            </ul>
          </address>
          ...
          <address class="l-footer__branch" id="footer-branch-hp">
            ...
            <ul class="l-footer__branch-list" role="list">
              ...
              <li class="l-footer__branch-item">
                ...
                <a href="mailto:<?php echo $branch_hp_email; ?>" aria-label="Email chi nhánh Hải Phòng CMB"><?php echo $branch_hp_email; ?></a>
              </li>
            </ul>
          </address>
          ...
          <address class="l-footer__branch" id="footer-branch-hcm">
            ...
            <ul class="l-footer__branch-list" role="list">
              ...
              <li class="l-footer__branch-item">
                ...
                <a href="mailto:<?php echo $branch_hcm_email; ?>" aria-label="Email chi nhánh TP. HCM CMB"><?php echo $branch_hcm_email; ?></a>
              </li>
            </ul>
          </address>
  ...
  <div class="c-float-actions" aria-label="Liên hệ nhanh">
    ...
    <a href="<?php echo $float_zalo; ?>" class="c-float-actions__btn" target="_blank" rel="noopener" aria-label="Liên hệ Zalo">
    ...
    <a href="<?php echo $float_messenger; ?>" class="c-float-actions__btn" target="_blank" rel="noopener" aria-label="Chat Messenger">
